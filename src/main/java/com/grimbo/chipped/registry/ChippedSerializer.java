...
public class ChippedSerializer {
    ...
    public static void register() {
        Registry.register(Registry.RECIPE_SERIALIZER, new ResourceLocation(Chipped.MOD_ID, "botanist_workbench"), new ChippedRecipe.Serializer(BOTANIST_WORKBENCH_TYPE, ChippedBlocks.BOTANIST_WORKBENCH));
        Registry.register(Registry.RECIPE_SERIALIZER, new ResourceLocation(Chipped.MOD_ID, "glassblower"), new ChippedRecipe.Serializer(GLASSBLOWER_TYPE, ChippedBlocks.GLASSBLOWER));
