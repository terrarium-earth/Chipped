...
public class ChippedItemModelProvider extends ItemModelProvider {
	...
	protected void registerModels() {
		...
		applyDefault(
				...
				DIORITE, BASALT, MOSSY_STONE_BRICKS, BRICKS, ANCIENT_DEBRIS, BLUE_ICE, DARK_PRISMARINE, DIRT, GRANITE, ICE, LAPIS_BLOCK, COAL_BLOCK, LODESTONE,
				MAGMA_BLOCK, NETHER_BRICKS, PACKED_ICE, PRISMARINE, PURPUR_BLOCK, QUARTZ_BLOCK, RED_NETHER_BRICKS, RED_SANDSTONE, REDSTONE_BLOCK, SANDSTONE,
				SMOOTH_STONE, SNOW_BLOCK, DIAMOND_BLOCK, EMERALD_BLOCK, GOLD_BLOCK, IRON_BLOCK, NETHERITE_BLOCK, BOOKSHELF, GRAVEL, SAND, TERRACOTTA
		);
