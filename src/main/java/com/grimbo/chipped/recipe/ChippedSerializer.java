...
public class ChippedSerializer {
    ...
    public static void register() {
        Registry.register(Registry.RECIPE_SERIALIZER, new ResourceLocation(Chipped.MOD_ID, "botanist_workbench"), new ChippedRecipe.Serializer(ALCHEMY_BENCH_TYPE, ChippedBlocks.ALCHEMY_BENCH));
        Registry.register(Registry.RECIPE_SERIALIZER, new ResourceLocation(Chipped.MOD_ID, "glassblower"), new ChippedRecipe.Serializer(BOTANIST_WORKBENCH_TYPE, ChippedBlocks.BOTANIST_WORKBENCH));
        Registry.register(Registry.RECIPE_SERIALIZER, new ResourceLocation(Chipped.MOD_ID, "carpenters_table"), new ChippedRecipe.Serializer(CARPENTERS_TABLE_TYPE, ChippedBlocks.CARPENTERS_TABLE));
        Registry.register(Registry.RECIPE_SERIALIZER, new ResourceLocation(Chipped.MOD_ID, "loom_table"), new ChippedRecipe.Serializer(LOOM_TABLE_TYPE, ChippedBlocks.LOOM_TABLE));
        Registry.register(Registry.RECIPE_SERIALIZER, new ResourceLocation(Chipped.MOD_ID, "mason_table"), new ChippedRecipe.Serializer(MASON_TABLE_TYPE, ChippedBlocks.MASON_TABLE));
        Registry.register(Registry.RECIPE_SERIALIZER, new ResourceLocation(Chipped.MOD_ID, "alchemy_bench"), new ChippedRecipe.Serializer(ALCHEMY_BENCH_TYPE, ChippedBlocks.ALCHEMY_BENCH));
