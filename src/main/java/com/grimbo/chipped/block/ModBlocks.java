...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> BLACK_STAINED_GLASS_1 = register("black_stained_glass_1",
            () -> createStainedGlassFromColor(DyeColor.BLACK));
    ...
    public static void registerBlocks(final RegistryEvent.Register<Block> event) {
        if (FMLEnvironment.dist == Dist.CLIENT) {
            ...
            // Black Stained Glass
            RenderTypeLookup.setRenderLayer(BLACK_STAINED_GLASS_1.get(), translucentRenderType);
    ...
    private static StainedGlassBlock createStainedGlassFromColor(DyeColor color) {
        return new StainedGlassBlock(color, AbstractBlock.Properties.create(Material.GLASS, color).hardnessAndResistance(0.3F).sound(SoundType.GLASS).notSolid().setAllowsSpawn(ModBlocks::neverAllowSpawn).setOpaque(ModBlocks::isntSolid).setSuffocates(ModBlocks::isntSolid).setBlocksVision(ModBlocks::isntSolid));
     }
