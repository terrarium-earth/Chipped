...
public class ChippedScreen extends ContainerScreen<ChippedContainer> {
    ...
    public ChippedScreen(ChippedContainer containerIn, PlayerInventory playerInv, ITextComponent titleIn) {
    ...
    protected void renderHoveredTooltip(MatrixStack matrixStack, int x, int y) {
        ...
        if (this.hasItemsInInputSlot) {
            ...
            List<ChippedRecipe> list = this.container.getRecipeList();
