...
public class ModBlocks {
    ...
    public static final ResourcefulRegistry<Block> ICE = createRegistry(Blocks.ICE, Palette.STONE);
    ...
    public static final ResourcefulRegistry<Block> GLASS = createRegistry(Blocks.GLASS, Palette.GLASS, GlassBlock::new);
    ...
    public static final ResourcefulRegistry<Block> BLACK_STAINED_GLASS = createRegistry(Blocks.BLACK_STAINED_GLASS, Palette.STAINED_GLASS, GlassBlock::new);
    ...
    public static final ResourcefulRegistry<Block> BLUE_STAINED_GLASS = createRegistry(Blocks.BLUE_STAINED_GLASS, Palette.STAINED_GLASS, GlassBlock::new);
    ...
    public static final ResourcefulRegistry<Block> BROWN_STAINED_GLASS = createRegistry(Blocks.BROWN_STAINED_GLASS, Palette.STAINED_GLASS, GlassBlock::new);
    ...
    public static final ResourcefulRegistry<Block> CYAN_STAINED_GLASS = createRegistry(Blocks.CYAN_STAINED_GLASS, Palette.STAINED_GLASS, GlassBlock::new);
    ...
    public static final ResourcefulRegistry<Block> GRAY_STAINED_GLASS = createRegistry(Blocks.GRAY_STAINED_GLASS, Palette.STAINED_GLASS, GlassBlock::new);
    ...
    public static final ResourcefulRegistry<Block> GREEN_STAINED_GLASS = createRegistry(Blocks.GREEN_STAINED_GLASS, Palette.STAINED_GLASS, GlassBlock::new);
    ...
    public static final ResourcefulRegistry<Block> LIGHT_BLUE_STAINED_GLASS = createRegistry(Blocks.LIGHT_BLUE_STAINED_GLASS, Palette.STAINED_GLASS, GlassBlock::new);
    ...
    public static final ResourcefulRegistry<Block> LIGHT_GRAY_STAINED_GLASS = createRegistry(Blocks.LIGHT_GRAY_STAINED_GLASS, Palette.STAINED_GLASS, GlassBlock::new);
    ...
    public static final ResourcefulRegistry<Block> LIME_STAINED_GLASS = createRegistry(Blocks.LIME_STAINED_GLASS, Palette.STAINED_GLASS, GlassBlock::new);
    ...
    public static final ResourcefulRegistry<Block> MAGENTA_STAINED_GLASS = createRegistry(Blocks.MAGENTA_STAINED_GLASS, Palette.STAINED_GLASS, GlassBlock::new);
    ...
    public static final ResourcefulRegistry<Block> ORANGE_STAINED_GLASS = createRegistry(Blocks.ORANGE_STAINED_GLASS, Palette.STAINED_GLASS, GlassBlock::new);
    ...
    public static final ResourcefulRegistry<Block> PINK_STAINED_GLASS = createRegistry(Blocks.PINK_STAINED_GLASS, Palette.STAINED_GLASS, GlassBlock::new);
    ...
    public static final ResourcefulRegistry<Block> PURPLE_STAINED_GLASS = createRegistry(Blocks.PURPLE_STAINED_GLASS, Palette.STAINED_GLASS, GlassBlock::new);
    ...
    public static final ResourcefulRegistry<Block> RED_STAINED_GLASS = createRegistry(Blocks.RED_STAINED_GLASS, Palette.STAINED_GLASS, GlassBlock::new);
    ...
    public static final ResourcefulRegistry<Block> WHITE_STAINED_GLASS = createRegistry(Blocks.WHITE_STAINED_GLASS, Palette.STAINED_GLASS, GlassBlock::new);
    ...
    public static final ResourcefulRegistry<Block> YELLOW_STAINED_GLASS = createRegistry(Blocks.YELLOW_STAINED_GLASS, Palette.STAINED_GLASS, GlassBlock::new);
    ...
    public static ResourcefulRegistry<Block> createRegistry(Block ref, Palette palette, Function<BlockBehaviour.Properties, Block> blockType, BiFunction<Block, Item.Properties, BlockItem> itemType) {
        ...
        for (int i = 0; i < palette.getNames().length; i++) {
            String id = palette.getName(i).formatted(Registry.BLOCK.getKey(ref).getPath().toLowerCase(Locale.ROOT));
    ...
    public static Pair<ResourcefulRegistry<Block>, ResourcefulRegistry<Block>> createTorchRegistry(Block ref1, Block ref2, Palette palette, BiFunction<BlockBehaviour.Properties, ParticleOptions, Block> blockType1, BiFunction<BlockBehaviour.Properties, ParticleOptions, Block> blockType2) {
        ...
        for (int i = 0; i < palette.getNames().length; i++) {
            String id1 = palette.getName(i).formatted(Registry.BLOCK.getKey(ref1).getPath().toLowerCase(Locale.ROOT));
            RegistryEntry<Block> torch1 = registry1.register(id1, () -> blockType1.apply(createProperties(ref1), ParticleTypes.FLAME));

            String id2 = palette.getName(i).formatted(Registry.BLOCK.getKey(ref2).getPath().toLowerCase(Locale.ROOT));
    ...
    public static ResourcefulRegistry<Block> registerSpecialLanterns(String block, Palette palette) {
        ...
        registry.register(names[0].formatted(block), () -> new SpecialLanternBlock(createProperties(Blocks.LANTERN), SpecialLanternBlock.CHONK_LANTERN_SHAPE));
        registry.register(names[1].formatted(block), () -> new SpecialLanternBlock(createProperties(Blocks.LANTERN), SpecialLanternBlock.DONUT_LANTERN_SHAPE_EAST, SpecialLanternBlock.DONUT_LANTERN_SHAPE_NORTH));
        registry.register(names[2].formatted(block), () -> new SpecialLanternBlock(createProperties(Blocks.LANTERN), SpecialLanternBlock.TALL_LANTERN_SHAPE));
        registry.register(names[3].formatted(block), () -> new SpecialLanternBlock(createProperties(Blocks.LANTERN), SpecialLanternBlock.THICC_LANTERN_SHAPE));
