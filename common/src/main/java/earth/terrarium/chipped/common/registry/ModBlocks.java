...
public class ModBlocks {
    ...
    public static final ChippedPaletteRegistry<Block> GLASS = createRegistry(Blocks.GLASS, Palettes.GLASS, p -> new TransparentBlock(p) {});
    ...
    public static final ChippedPaletteRegistry<Block> BLACK_STAINED_GLASS = createRegistry(Blocks.BLACK_STAINED_GLASS, Palettes.STAINED_GLASS, p -> new TransparentBlock(p) {});
    ...
    public static final ChippedPaletteRegistry<Block> BLUE_STAINED_GLASS = createRegistry(Blocks.BLUE_STAINED_GLASS, Palettes.STAINED_GLASS, p -> new TransparentBlock(p) {});
    ...
    public static final ChippedPaletteRegistry<Block> BROWN_STAINED_GLASS = createRegistry(Blocks.BROWN_STAINED_GLASS, Palettes.STAINED_GLASS, p -> new TransparentBlock(p) {});
    ...
    public static final ChippedPaletteRegistry<Block> CYAN_STAINED_GLASS = createRegistry(Blocks.CYAN_STAINED_GLASS, Palettes.STAINED_GLASS, p -> new TransparentBlock(p) {});
    ...
    public static final ChippedPaletteRegistry<Block> GRAY_STAINED_GLASS = createRegistry(Blocks.GRAY_STAINED_GLASS, Palettes.STAINED_GLASS, p -> new TransparentBlock(p) {});
    ...
    public static final ChippedPaletteRegistry<Block> GREEN_STAINED_GLASS = createRegistry(Blocks.GREEN_STAINED_GLASS, Palettes.STAINED_GLASS, p -> new TransparentBlock(p) {});
    ...
    public static final ChippedPaletteRegistry<Block> LIGHT_BLUE_STAINED_GLASS = createRegistry(Blocks.LIGHT_BLUE_STAINED_GLASS, Palettes.STAINED_GLASS, p -> new TransparentBlock(p) {});
    ...
    public static final ChippedPaletteRegistry<Block> LIGHT_GRAY_STAINED_GLASS = createRegistry(Blocks.LIGHT_GRAY_STAINED_GLASS, Palettes.STAINED_GLASS, p -> new TransparentBlock(p) {});
    ...
    public static final ChippedPaletteRegistry<Block> LIME_STAINED_GLASS = createRegistry(Blocks.LIME_STAINED_GLASS, Palettes.STAINED_GLASS, p -> new TransparentBlock(p) {});
    ...
    public static final ChippedPaletteRegistry<Block> MAGENTA_STAINED_GLASS = createRegistry(Blocks.MAGENTA_STAINED_GLASS, Palettes.STAINED_GLASS, p -> new TransparentBlock(p) {});
    ...
    public static final ChippedPaletteRegistry<Block> ORANGE_STAINED_GLASS = createRegistry(Blocks.ORANGE_STAINED_GLASS, Palettes.STAINED_GLASS, p -> new TransparentBlock(p) {});
    ...
    public static final ChippedPaletteRegistry<Block> PINK_STAINED_GLASS = createRegistry(Blocks.PINK_STAINED_GLASS, Palettes.STAINED_GLASS, p -> new TransparentBlock(p) {});
    ...
    public static final ChippedPaletteRegistry<Block> PURPLE_STAINED_GLASS = createRegistry(Blocks.PURPLE_STAINED_GLASS, Palettes.STAINED_GLASS, p -> new TransparentBlock(p) {});
    ...
    public static final ChippedPaletteRegistry<Block> RED_STAINED_GLASS = createRegistry(Blocks.RED_STAINED_GLASS, Palettes.STAINED_GLASS, p -> new TransparentBlock(p) {});
    ...
    public static final ChippedPaletteRegistry<Block> WHITE_STAINED_GLASS = createRegistry(Blocks.WHITE_STAINED_GLASS, Palettes.STAINED_GLASS, p -> new TransparentBlock(p) {});
    ...
    public static final ChippedPaletteRegistry<Block> YELLOW_STAINED_GLASS = createRegistry(Blocks.YELLOW_STAINED_GLASS, Palettes.STAINED_GLASS, p -> new TransparentBlock(p) {});
