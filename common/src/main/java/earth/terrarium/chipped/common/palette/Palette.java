...
public enum Palette {
    ...
    SNOW_BLOCK(STONE, List.of()),
    STONE_BRICKS(STONE, List.of("%_bricks")),
    ...
    GLASS("arched_leaded_%_pillar", "circle_oak_%", "clear_leaded_%", "fancy_leaded_%", "large_diamond_leaded_%", "lead_woven_%", "oak_bared_%", "oak_bordered_%", "oak_diamond_bordered_%", "oak_horizontal_lined_%", "oak_large_diamond_%", "oak_line_bared_%", "oak_ornate_bared_%", "oak_snowflake_%", "oak_woven-%", "ornate_leaded_%", "raster_leaded_%", "small_diamond_leaded_%", "square_leaded_%", "square_oak_%", "vertical_leaded_%"),
